...
`yarn add react-native-wheel-picker-android-maren-tech`
...
`react-native link react-native-wheel-picker-android-maren-tech`
...
```
include ':react-native-wheel-picker-android-maren-tech'
project(':react-native-wheel-picker-android-maren-tech').projectDir = new File(rootProject.projectDir, '../node_modules/react-native-wheel-picker-android-maren-tech/android')
```
...
dependencies {
    ...
    compile project(':react-native-wheel-picker-android-maren-tech')
}
```
...
import {
  ...
  TimePicker,
  DatePicker
} from "react-native-wheel-picker-android-maren-tech";
...
Feel free to [open an issue](https://github.com/sanjithmsk/react-native-wheel-picker-android-maren-tech/issues)
